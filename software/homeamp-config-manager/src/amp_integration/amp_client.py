...
class AMPClient:
    ...
    def _login(self) -> bool:
        ...
        try:
            response = requests.post(
                ...
                json={"username": self.username, "password": self.password, "token": "", "rememberMe": False},
                timeout=30,
            )
    ...
    def _api_call(self, endpoint: str, data: Optional[Dict] = None) -> Optional[Dict]:
        ...
        try:
            ...
            response = requests.post(url, json=data or {}, headers=headers, params=params, timeout=30)
    ...
    def send_console_command(self, instance_id: str, command: str) -> bool:
        ...
        """
        result = self._api_call("Core/SendConsoleMessage", {"InstanceId": instance_id, "message": command})
        return result is not None
    ...
    def update_instance_config(self, instance_id: str, config_updates: Dict[str, Any]) -> bool:
        ...
        """
        result = self._api_call("Core/SetConfigs", {"InstanceId": instance_id, "data": config_updates})
        return result is not None
    ...
    def get_file_listing(self, instance_id: str, directory: str = "") -> Optional[List[Dict]]:
        ...
        """
        return self._api_call("FileManagerPlugin/GetDirectoryListing", {"InstanceId": instance_id, "Dir": directory})
    ...
    def delete_file(self, instance_id: str, file_path: str) -> bool:
        ...
        """
        result = self._api_call("FileManagerPlugin/DeleteFile", {"InstanceId": instance_id, "Filename": file_path})
        return result is not None
    ...
    def rename_file(self, instance_id: str, old_path: str, new_path: str) -> bool:
        ...
        result = self._api_call(
            "FileManagerPlugin/RenameFile", {"InstanceId": instance_id, "Filename": old_path, "NewFilename": new_path}
        )
        return result is not None
    ...
    def create_backup(self, instance_id: str, title: str, description: str = "") -> Optional[str]:
        ...
        result = self._api_call(
            ...
            {"InstanceId": instance_id, "Title": title, "Description": description, "Sticky": False},
        )
    ...
    def restore_backup(self, instance_id: str, backup_id: str) -> bool:
        ...
        result = self._api_call(
            "LocalFileBackupPlugin/RestoreBackup", {"InstanceId": instance_id, "BackupId": backup_id}
        )
        return result is not None

    def list_backups(self, instance_id: str) -> List[Dict[str, Any]]:
        """List all backups for instance"""
        result = self._api_call("LocalFileBackupPlugin/GetBackups", {"InstanceId": instance_id})
        if result and isinstance(result, list):
            return result
        return []
...
class AMPPluginDeployer:
    ...
    def deploy_plugin(
        self, instance_id: str, plugin_jar: Path, backup_old: bool = True, restart_server: bool = True
    ) -> bool:
        """
...
def main():
    ...
    # Example usage
    amp = AMPClient(base_url="http://localhost:8080", username="admin", password="password")
