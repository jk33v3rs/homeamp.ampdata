...
class YAMLHandler:
    ...
    def modify_key(self, data: Dict[str, Any], key_path: str, new_value: Any) -> bool:
        """
...
def modify_yaml_key(file_path: Union[str, Path], key_path: str, new_value: Any, create_backup: bool = True) -> bool:
    """
