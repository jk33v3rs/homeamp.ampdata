...
def setup_logging(
    level: str = "INFO", console_enabled: bool = True, file_enabled: bool = False, file_path: Optional[str] = None
) -> Logger:
    """
    ...
    """
    config = LogConfig(level=level, console_enabled=console_enabled, file_enabled=file_enabled, file_path=file_path)
