...
class MapSyncService:
    ...
    def _sync_prefix(self, prefix: str, target_dir: Path) -> int:
        ...
        try:
            ...
            objects = self.minio.list_objects(self.bucket_name, prefix=f"{prefix}/", recursive=True)
            ...
            for obj in objects:
                ...
                if self._needs_update(obj.object_name, obj.etag):
                    ...
                    self.minio.fget_object(self.bucket_name, obj.object_name, str(local_path))
    ...
    def get_instance_list(self, access_level: str) -> list:
        ...
        try:
            objects = self.minio.list_objects(self.bucket_name, prefix=f"{access_level}/", recursive=False)
    ...
    def generate_liveatlas_config(self, access_level: str, output_file: str):
        ...
        config = {
            ...
            "messages": {"chatPlayerJoin": "{player} joined", "chatPlayerQuit": "{player} left"},
        }
...
def main():
    ...
    try:
        while True:
            ...
            logger.info(
                f"Status: {status['synced_files']} files tracked, "
