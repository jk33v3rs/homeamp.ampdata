...
class PluginChecker:
    ...
    def check_hangar(self, plugin_slug: str) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            versions_response = requests.get(
                versions_url, headers=headers, timeout=settings.http_config.timeout_seconds
            )
    ...
    def generate_update_report(self, output_path: Path, update_data: Dict[str, Dict[str, Any]]) -> None:
        ...
        report = {
            ...
            "recommendations": {"high_priority": high_risk, "medium_priority": medium_risk, "low_priority": low_risk},
        }
