...
class ConfigUpdater:
    ...
    def verify_expected_value(
        self, server_name: str, plugin_name: str, config_file: str, key_path: str, expected_value: Any
    ) -> bool:
        """
        ...
        try:
            ...
            if not SafetyValidator.validate_config_file_exists(
                server_name, plugin_name, config_file, self.utildata_path
            ):
                return False
    ...
    def apply_single_change(self, change: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if not action or not file_path:
            return {"success": False, "error": "Missing action or file_path", "change": change}
        ...
        try:
            if action == "update_yaml_key":
                ...
                return {"success": False, "error": f"Unknown action: {action}", "change": change}
        except Exception as e:
    ...
    def _update_yaml_key(self, file_path: Path, change: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"success": False, "action": "update_yaml_key", "file_path": str(file_path), "error": str(e)}
    ...
    def _replace_line(self, file_path: Path, change: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if not old_line or not new_line:
            return {"success": False, "error": "Missing old_line or new_line", "action": "replace_line"}
        ...
        try:
            ...
            return {"success": replaced, "action": "replace_line", "file_path": str(file_path), "replaced": replaced}
        except Exception as e:
            return {"success": False, "action": "replace_line", "file_path": str(file_path), "error": str(e)}

    def _add_line(self, file_path: Path, change: Dict[str, Any]) -> Dict[str, Any]:
        """Add a line to a file"""
        if self.dry_run:
            return {"success": True, "action": "add_line", "file_path": str(file_path), "dry_run": True}
        ...
        try:
            ...
            return {"success": True, "action": "add_line", "file_path": str(file_path)}
        except Exception as e:
            return {"success": False, "action": "add_line", "file_path": str(file_path), "error": str(e)}

    def _delete_line(self, file_path: Path, change: Dict[str, Any]) -> Dict[str, Any]:
        """Delete a line from a file"""
        if self.dry_run:
            return {"success": True, "action": "delete_line", "file_path": str(file_path), "dry_run": True}
        ...
        try:
            ...
            return {"success": deleted, "action": "delete_line", "file_path": str(file_path), "deleted": deleted}
        except Exception as e:
            return {"success": False, "action": "delete_line", "file_path": str(file_path), "error": str(e)}
    ...
    def apply_change_request(self, change_request: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if not self.validate_change_request(change_request):
            return {"success": False, "request_id": request_id, "error": "Change request validation failed"}
        ...
        if not self.dry_run:
            ...
            if not backup_path:
                return {"success": False, "request_id": request_id, "error": "Failed to create backup"}
    ...
    def rollback_change(self, change_id: str) -> Dict[str, Any]:
        ...
        if not self.backup_dir:
            return {"success": False, "error": "No backup directory available for rollback"}
