...
class BedrockUpdater:
    ...
    BEDROCK_DEPLOYMENT = {
        "velocity_proxy": {"server": "OVH-Ryzen", "instance": "Velocity01", "plugins": ["viaversion", "viabackwards"]},
        "geyser_proxy": {
            "server": "OVH-Ryzen",
            "instance": "Geyser01",
            "plugins": ["geyser_standalone", "floodgate_standalone"],
        },
        "network_servers": {"pattern": "all_spigot_servers", "plugins": ["floodgate_spigot"]},
    }
    ...
    def update_geyser_standalone(self, target_path: Optional[Path] = None) -> Dict[str, Any]:
        ...
        """
        result = {"plugin": "Geyser-Standalone", "success": False, "version": None, "error": None}
    ...
    def update_floodgate(self, platform: str = "both", target_servers: Optional[List[str]] = None) -> Dict[str, Any]:
        ...
        Returns:
            Update result dictionary
        """
        results = {"plugin": "Floodgate", "updates": [], "success": True}
            ...
            if platform in ["standalone", "both"]:
                ...
                if version_info:
                    ...
                    if self.download_plugin(version_info["download_url"], target):
                        ...
                        results["updates"].append(
                            {"location": "Geyser01 (proxy)", "success": False, "error": "Download failed"}
                        )
        ...
        try:
            ...
            if via_info:
                ...
                if self.download_plugin(via_info["download_url"], target):
                    ...
                    results["success"] = False
                    results["plugins"].append({"name": "ViaVersion", "success": False, "error": "Download failed"})
            ...
            if include_viabackwards:
                ...
                if vb_info:
                    ...
                    if self.download_plugin(vb_info["download_url"], target):
                        ...
                        results["success"] = False
                        results["plugins"].append(
                            {"name": "ViaBackwards", "success": False, "error": "Download failed"}
                        )
