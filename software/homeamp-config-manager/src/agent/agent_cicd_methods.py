...
class AgentCICDMethods:
    ...
    def _handle_new_version(self, plugin_id: str, update_info: Dict):
        ...
        try:
            ...
            """,
                {"plugin_id": plugin_id, "version": update_info["version"]},
            )
    ...
    def _queue_plugin_update(
        self, plugin_id: str, update_info: Dict, target_instances: List[str] = None, priority: int = 5
    ):
    ...
    def _execute_plugin_update(self, update_task: Dict):
        ...
        try:
            ...
            target_instances = (
                json.loads(update_task["target_instances"]) if update_task["target_instances"] != "*" else None
            )
            ...
            self.db.execute_query(
                ...
                WHERE id = %(id)s
            """,
                {"id": task_id, "success": success_count, "failure": failure_count},
            )
    ...
    def _deploy_plugin_to_instance(self, instance_id: str, plugin_id: str, jar_path: Path, version: str) -> bool:
