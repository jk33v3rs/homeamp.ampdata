...
class EnhancedDiscovery:
    ...
    def run_full_discovery(self, instances: List[Dict[str, Any]], plugins: List[str]) -> Dict[str, Any]:
        ...
        self.logger.info(
            f"Enhanced discovery complete: {variance_count} variances, "
...
class HeartbeatMonitor:
    ...
    def __init__(self, db_config: Dict[str, Any], agent_id: str, server_name: str, logger: logging.Logger = None):
        """
