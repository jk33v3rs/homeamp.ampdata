...
class ConfigModifier:
    ...
    def modify_yaml_key(self, file_path: str, key_path: str, value: Any,
                       create_backup: bool = True, backup_reason: str = 'modification') -> bool:
        """
    ...
    def modify_properties_key(self, file_path: str, key: str, value: str,
                             create_backup: bool = True) -> bool:
        """
    ...
    def safe_modify(self, file_path: str, key_path: str, value: Any,
                   validate_after: bool = True) -> Tuple[bool, Optional[str]]:
        """
...
if __name__ == '__main__':
    ...
    results = modifier.batch_modify([
        {
            'file_path': '/path/to/config1.yml',
            'key_path': 'setting.a',
            'value': 'value1'
        },
        {
            'file_path': '/path/to/config2.json',
            'key_path': 'setting.b',
            'value': 100
        }
    ])
