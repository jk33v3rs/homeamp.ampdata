...
class ConfigTemplateManager:
    ...
    def get_template(
        self, template_id: Optional[int] = None, template_name: Optional[str] = None
    ...
    def list_templates(
        self, plugin_name: Optional[str] = None, tags: Optional[List[str]] = None, limit: int = 100
    ) -> List[Dict[str, Any]]:
        """
    ...
    def apply_template(self, template_id: int, instance_id: str, merge_strategy: str = "replace") -> Dict[str, Any]:
        """
    ...
    def clone_from_instance(
        self, instance_id: str, plugin_name: str, template_name: str, description: str = "", created_by: str = "system"
    ) -> int:
        """
