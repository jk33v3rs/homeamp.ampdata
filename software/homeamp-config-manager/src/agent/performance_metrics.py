...
class PerformanceMetrics:
    ...
    def record_metric(
        ...
        self.cursor.execute(query, (metric_name, metric_value, metric_unit, component, operation, metadata_json))

        self.db.commit()

    @contextmanager
    def measure_time(self, metric_name: str, component: str, operation: str, metadata: Optional[Dict[str, Any]] = None):
        """
    ...
    def get_slow_operations(self, component: Optional[str] = None, threshold_ms: float = 1000, limit: int = 10) -> list:
        """
