...
class WorldScanner:
    ...
    def scan_all_instances(
        self, 
        instance_registry: Dict[str, Path]
    ) -> Dict[str, List[WorldInfo]]:
        """
...
class WorldDatabaseImporter:
    ...
    def import_scan_results(
        self, 
        scan_results: Dict[str, List[WorldInfo]]
    ) -> Dict[str, int]:
        """
...
if __name__ == '__main__':
    ...
    worlds = scanner.scan_instance(
        instance_id="BENT01",
        instance_path=Path("/path/to/Servers/BENT01")
    )
