...
class ServerAwareConfigEngine:
    ...
    def detect_server_from_amp_instance(self, instance_id: str, amp_client) -> Optional[str]:
        """
    ...
    def apply_server_variables(self, config: Dict[str, Any], server_name: str) -> Dict[str, Any]:
        """
    ...
    def write_config_file(self, config: Dict[str, Any], output_path: Path, format: str = "yaml") -> bool:
        """
    ...
    def deploy_config_to_server(
        self, plugin_name: str, server_name: str, amp_instance_id: str, amp_client, config_filename: str = "config.yml"
    ) -> bool:
        """
