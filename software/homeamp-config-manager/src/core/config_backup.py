...
class ConfigBackupManager:
    ...
    def backup_config(self, config_file: Path, server_name: str, plugin_name: str) -> Optional[Path]:
        """
    ...
    def backup_plugin_configs(self, plugin_dir: Path, server_name: str, plugin_name: str) -> Optional[Path]:
        """
    ...
    def list_backups(
        self, server_name: Optional[str] = None, plugin_name: Optional[str] = None
    ) -> List[Dict[str, Any]]:
        """
