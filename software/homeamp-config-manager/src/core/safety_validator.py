...
class SafetyValidator:
    ...
    @staticmethod
    def validate_config_file_exists(server_name: str, plugin_name: str, config_file: str, utildata_path: Path) -> bool:
        """
        ...
        try:
            ...
            if not config_path.exists():
                print(
                    f"Error: Config file '{config_file}' not found for plugin '{plugin_name}' on server '{server_name}'"
                )
                return False
    ...
    @staticmethod
    def validate_expected_value(current_value: Any, expected_value: Any, strict: bool = True) -> bool:
        """
