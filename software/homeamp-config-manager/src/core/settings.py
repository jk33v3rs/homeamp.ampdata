...
class SettingsHandler:
    ...
    def plugin_update_config(self) -> PluginUpdateConfig:
        ...
        return PluginUpdateConfig(
            ...
            spigot_base_url=updates.get("spigot_base_url", "https://api.spigotmc.org/simple/0.1/index.php"),
            bukkit_base_url=updates.get("bukkit_base_url", "https://servermods.forgesvc.net/servermods"),
            github_base_url=updates.get("github_base_url", "https://api.github.com"),
    ...
    def DB_PORT(self) -> int:
        """Get database port"""
        return self.get("database", "port", default=3369)
    ...
    def log_format(self) -> str:
        """Get logging format"""
        return self.get(
            "agent", "logging", "log_format", default="%(asctime)s - %(name)s - %(levelname)s - %(message)s"
        )
