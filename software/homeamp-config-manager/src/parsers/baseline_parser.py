...
class BaselineParser:
        ...
        while i < len(lines):
            ...
            # Check for YAML code block
                ...
                if yaml_content and self.current_plugin and self.current_file:
                    parsed = self._parse_yaml_content(yaml_content, self.current_plugin, self.current_file)
    ...
    def _parse_yaml_content(self, yaml_content: str, plugin_id: str, config_file: str) -> List[ParsedConfig]:
        """
    ...
    def _flatten_dict(
        self, data: Dict[str, Any], plugin_id: str, config_file: str, prefix: str, configs: List[ParsedConfig]
    ):
        """
