...
class ConfigDatabase:
    ...
    def resolve_config_value(
        self, instance_id: str, plugin_name: str, config_file: str, config_key: str
    ) -> Tuple[Any, int, str]:
        """
        ...
        self.cursor.execute(
            ...
            LIMIT 1
        """,
            (plugin_name, config_file, config_key, server_name, ",".join(groups) if groups else "", instance_id),
        )
    ...
    def get_variable_value(self, variable_name: str, scope_type: str, scope_identifier: str) -> Optional[str]:
    ...
    def update_deployment_status(self, deployment_id: int, status: str, error_message: Optional[str] = None):
