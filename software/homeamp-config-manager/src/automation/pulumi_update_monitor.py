...
class PluginUpdateMonitor:
    ...
    def __init__(self, staging_path: Path, plugin_registry_path: Path, excel_output_path: Optional[Path] = None):
        """
    ...
    async def _check_plugin_update(self, plugin_name: str, plugin_info: Dict[str, Any]) -> Optional[PluginUpdate]:
    ...
    async def _check_github_release(
        self, plugin_name: str, plugin_info: Dict[str, Any], current_version: str
    ) -> Optional[PluginUpdate]:
    ...
    async def _check_spigot_resource(
        self, plugin_name: str, plugin_info: Dict[str, Any], current_version: str
    ) -> Optional[PluginUpdate]:
    ...
    async def _check_bukkit_resource(
        self, plugin_name: str, plugin_info: Dict[str, Any], current_version: str
    ) -> Optional[PluginUpdate]:
    ...
    async def _check_jenkins_build(
        self, plugin_name: str, plugin_info: Dict[str, Any], current_version: str
    ) -> Optional[PluginUpdate]:
...
async def main():
    ...
    monitor = PluginUpdateMonitor(
        staging_path=staging_path, plugin_registry_path=registry_path, excel_output_path=excel_path
    )
